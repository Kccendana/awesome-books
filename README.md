...
<div align="center">
  ...
  <img src="assets/awesome-books_logo.svg" alt="logo" width="140"  height="auto" />
  <br/>
...
**AwesomeBooks** is a page that let the user add and remove books. 
...
```
  git clone https://github.com/Kccendana/awesome-books.git
  cd awesome-books
```
...
Feel free to check the [issues page](https://github.com/Kccendana/awesome-books/issues).
